...
if (stitchchoice == 1){
	...
	print(logfile, "Stitching a "+ x_grid + " x " + y_grid + " image with " + o + "% overlap between the tiles based on the " + stitch_print + " nm channel(s).");
	} else {
...
transformdir = "/Volumes/sd17B002/Microscopy-Dragonfly/Image-Analysis/ChromaticAbberationCorrection/transform-XML-file-to405nm-padFISH-15Sep2023/";
